...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .claude/skills/ue-build/Verify-Build.ps1
```
...
1. Trigger the compile (best-effort GUI automation — see caveat):
   ```powershell
   powershell -NoProfile -ExecutionPolicy Bypass -File .claude/skills/ue-build/Trigger-LiveCoding.ps1
   ```
